...
1. Info: Includes a 'catchy title' so users know about commission pieces and quick links to more info on contact and shipping page. Also includes credits to [Freepik](https://www.freepik.com/) which was used for the hero image.
2. Newsletter Sign up; straightforward for users to sign up to the newsletter to keep up to date with new artwork and news from the artist.
3. Social; users can find and follow social profiles of the artist with a clear overview of social channels available.
...
1. Slideshow Section: gives users examples of how the artwork could look in different interiors.
2. Overview of finished artpieces with prices.

- __About__

1. About The Artist: users can find a short background story on Llewelyn Henshaw.
2. Art Galleries: users can find out where the artists artwork is available and displayed.
3. Markets: users are informed of future art markets where they can meet and discuss in person with the artist.
